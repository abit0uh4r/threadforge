    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentification">
                    <a href="#authentification">Authentification</a>
                                ...
                                <a href="#authentification-POSTapi-register">Inscription</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-POSTapi-login">
                                <a href="#authentification-POSTapi-login">Connexion</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentification-POSTapi-logout">
                                <a href="#authentification-POSTapi-logout">Déconnexion</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="campaigns">
                    <a href="#campaigns">Campaigns</a>
                                ...
                                <a href="#campaigns-GETapi-campaigns">Liste des Blueprints</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="campaigns-POSTapi-campaigns">
                                <a href="#campaigns-POSTapi-campaigns">Créer un Blueprint</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="campaigns-GETapi-campaigns--id-">
                                <a href="#campaigns-GETapi-campaigns--id-">Détail d'un Blueprint</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="chat">
                    <a href="#chat">Chat</a>
                                    ...
                                    <ul id="tocify-subheader-chat" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="chat-POSTapi-posts--id--chat">
                                <a href="#chat-POSTapi-posts--id--chat">Discuter avec le Ghostwriter</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="content">
                    <a href="#content">Content</a>
                                    ...
                                    <ul id="tocify-subheader-content" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="content-POSTapi-content-repurpose">
                                <a href="#content-POSTapi-content-repurpose">Soumettre un contenu brut (Repurpose)</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="posts">
                    <a href="#posts">Posts</a>
                                ...
                                <a href="#posts-GETapi-posts">Liste des posts</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="posts-GETapi-posts--id-">
                                <a href="#posts-GETapi-posts--id-">Détail d'un post</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="posts-PATCHapi-posts--id--status">
                                <a href="#posts-PATCHapi-posts--id--status">Changer le statut d'un post</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
    ...
    <p>APIs pour la gestion de l'authentification (inscription, connexion, déconnexion).</p>

                                <h2 id="authentification-POSTapi-register">Inscription</h2>

<p>
</p>

<p>Crée un nouveau compte créateur et retourne un Bearer Token d'accès.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nom du créateur. Example: <code>Jane Doe</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Adresse email unique. Example: <code>jane@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Mot de passe (min 8 caractères). Example: <code>secret123</code></p>
        </div>
        </form>

                    <h2 id="authentification-POSTapi-login">Connexion</h2>

<p>
</p>

<p>Authentifie un créateur et retourne un Bearer Token d'accès.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Adresse email. Example: <code>jane@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nom de l'appareil (optionnel). Example: <code>iPhone 15</code></p>
        </div>
        </form>

                    <h2 id="authentification-POSTapi-logout">Déconnexion</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Révoque le token courant.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Gestion des Blueprints de campagne (règles de style réutilisables).</p>

                                <h2 id="campaigns-GETapi-campaigns">Liste des Blueprints</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourne toutes les campagnes du créateur authentifié avec le nombre de posts générés.</p>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="campaigns-POSTapi-campaigns">Créer un Blueprint</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Définit les règles de style strictes pour les futures générations de posts.</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nom de la campagne. Example: <code>Tech Twitter</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Audience cible. Example: <code>dev community</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               value="pro but casual"
               data-component="body">
    <br>
<p>Ton éditorial. Example: <code>pro but casual</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               step="any"               name="max_length"                data-endpoint="POSTapi-campaigns"
               value="280"
               data-component="body">
    <br>
<p>Longueur max du post (défaut: 280). Example: <code>280</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Nombre max de hashtags (défaut: 1). Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="rules[0]"                data-endpoint="POSTapi-campaigns"
               data-component="body">
        <input type="text" style="display: none"
               name="rules[1]"                data-endpoint="POSTapi-campaigns"
               data-component="body">
    <br>
<p>Règles additionnelles.</p>
        </div>
        </form>

                    <h2 id="campaigns-GETapi-campaigns--id-">Détail d&#039;un Blueprint</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourne une campagne spécifique avec le nombre de posts générés.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID de la campagne. Example: <code>1</code></p>
            </div>
                    </form>

                <h1 id="chat">Chat</h1>

    <p>Assistant conversationnel (Ghostwriter) pour retravailler les posts générés.</p>

                                <h2 id="chat-POSTapi-posts--id--chat">Discuter avec le Ghostwriter</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Pose une question en langage naturel sur un post généré. L'assistant
utilise des tools PHP pour interroger la base de données et maintient
la mémoire de la conversation via son ID.</p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID du post à discuter. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Le message/question pour l'assistant. Example: <code>Donne-moi 3 variantes plus agressives pour le hook</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="conversation_id"                data-endpoint="POSTapi-posts--id--chat"
               value="conv_abc123"
               data-component="body">
    <br>
<p>ID de conversation existante pour continuer le contexte (optionnel). Example: <code>conv_abc123</code></p>
        </div>
        </form>

                <h1 id="content">Content</h1>

    <p>Soumission et traitement du contenu brut pour génération de posts.</p>

                                <h2 id="content-POSTapi-content-repurpose">Soumettre un contenu brut (Repurpose)</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Envoie un contenu textuel en vrac et déclenche la transformation asynchrone.
Retourne immédiatement 202 Accepted sans attendre la génération.</p>
...
<div class="bash-example">
    ...
    --data "{
    \"campaign_id\": 1,
    \"content\": \"Laravel 11 introducedlazy loading prevention...\",
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>ID de la campagne (Blueprint) à appliquer. Example: <code>1</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               value="Laravel 11 introducedlazy loading prevention..."
               data-component="body">
    <br>
<p>Contenu brut à transformer (min 10 caractères). Example: <code>Laravel 11 introducedlazy loading prevention...</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Type de source (text, markdown, readme). Example: <code>markdown</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>Gestion du cycle de vie des posts générés (draft, archived, posted).</p>

                                <h2 id="posts-GETapi-posts">Liste des posts</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Retourne tous les posts générés par le créateur, avec eager loading.</p>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filtrer par statut (draft, archived, posted). Example: <code>draft</code></p>
            </div>
                </form>

                    <h2 id="posts-GETapi-posts--id-">Détail d&#039;un post</h2>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="url">
    <br>
<p>ID du post. Example: <code>1</code></p>
            </div>
                    </form>

                    <h2 id="posts-PATCHapi-posts--id--status">Changer le statut d&#039;un post</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Met à jour le cycle de vie du post (draft, archived, posted).</p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="status"                data-endpoint="PATCHapi-posts--id--status"
               value="posted"
               data-component="body">
    <br>
<p>Nouveau statut (draft, archived, posted). Example: <code>posted</code></p>
        </div>
        </form>
